    ...
    <section class="vbox">
        <section class="padder">
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <form class="form-horizontal" action="${ctx}/mvc/cooperation/modify/save" method="POST">
                        ...
                        <section class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                     ...
                                     <div class="col-sm-9">
                                         <input type="text" class="form-control" required name="name" onblur="trimText(this)" value="${coop.name}"/>
                                     </div>
                                </div>
                            </div>
